...
import { fetchFilteredConferences, fetchFilteredInvoices } from '@/app/lib/data';
              ...
              >
                {/* <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-100">{conference.end_date}</p>
                  </div>
                </div> */}
                <div className="flex w-full items-center justify-between pt-4">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    {/* <UpdateInvoice id={conference.id} />
                    <DeleteInvoice id={conference.id} /> */}
                  </div>
                </div>
              </div>
            ))}
              ...
              {conferences?.map((conference) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    {formatDateToLocal(conference.start_date)}
                  </td>
                  <td className="whitespace-nowrap py-3 pl-6 pr-3">
