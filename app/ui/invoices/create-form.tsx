import { CustomerField, Conference } from '@/app/lib/definitions';
...
import { createInvoice, submitPaper } from '@/app/lib/actions';

export function otherForm({ customers }: { customers: CustomerField[] }) {
  return (
    <form action={createInvoice}>
      <div className="rounded-md bg-dark-color p-4 md:p-6">
        ...
        <fieldset>
          ...
          <div className="rounded-md border border-gray-500 bg-dark-color px-[14px] py-3">
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-dark-color text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="pending"
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-dark-color px-3 py-1.5 text-xs font-medium text-gray-300"
                >
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-dark-color text-gray-300 focus:ring-2"
                />
                <label
                  htmlFor="paid"
...
export function Form({ conferences }: { conferences: Conference[] }) {
  return (
