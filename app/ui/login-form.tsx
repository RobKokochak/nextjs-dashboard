...
export default function LoginForm() {
  ...
  return (
    <form action={dispatch} className="space-y-3">
      <div className="flex-1 rounded-lg bg-dark-color px-6 pb-4 pt-8">
        ...
        <div className="w-full">
          <div>
            ...
            <div className="relative">
              <input
                className="peer block w-full rounded-md border bg-dark-color border-gray-400 py-[9px] pl-10 text-sm outline-2 text-gray-200 placeholder:text-gray-400"
                id="email"
                type="email"
                name="email"
